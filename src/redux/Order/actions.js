...
export function orderProceedAction(order) {
  return {
    type: ORDER_PROCEED_ACTION,
    payload: order
  }
}

export function getAllDeliveredOrdersAction() {
  return {
    type: GET_ALL_DELIVERED_ORDERS_ACTION
  }
}